  ...
  return (
    <section className="relative w-full mt-8">
      ...
      <div className="hidden lg:flex overflow-hidden">
        <Link
          href="/programacao/dia-1"
          className="hidden lg:flex relative w-full h-screen group cursor-pointer rflow-hidden"
        >
          <Image
            src="/day1_desktop.jpg"
            alt="Days"
            fill
          ...
          />
          <motion.div
            className="absolute inset-0 bg-black/0  transition-all duration-500 flex items-center justify-center"
            initial={{ opacity: 0 }}
        ...
        <Link
          href="/programacao/dia-2"
          className="hidden lg:flex relative w-full h-screen group cursor-pointer rflow-hidden"
        >
          <Image
            src="/day2_desktop.jpg"
            alt="Days"
            fill
            className="object-contain transition-transform duration-500 group-hover:scale-105"
            priority
          ...
          >
            <Link href="/programacao/dia-1">
              ...
              >
                ...
                >
                  <h2 className="text-2xl font-bold text-white">VER DIA 1</h2>
                </motion.div>
              </motion.div>
            </Link>
          </motion.div>
            ...
            <Link href="/programacao/dia-2">
              ...
              >
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="text-2xl font-bold text-white">VER DIA 2</h2>
                </motion.div>
              </motion.div>
            </Link>
          </motion.div>
